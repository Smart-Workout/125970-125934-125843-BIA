...
export default function UsageHeatmap({ cells = [] }: UsageHeatmapProps) {
  ...
  return (
    <section className="panel">
      ...
      <div className="heatmap-scroll">
        <div className="heatmap-grid" style={{ gridTemplateColumns: `104px repeat(${hours.length}, minmax(34px, 1fr))` }}>
